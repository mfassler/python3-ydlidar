...
def make_yellow_avoidance_area(img, PIXELS_PER_METER):
    ...
    max_left2 = h_center - int(round(max_width * PIXELS_PER_METER / 4))
    max_right2 = h_center + int(round(max_width * PIXELS_PER_METER / 4))
...
def make_black_avoidance_area(img, PIXELS_PER_METER):
    vehicle_width = 0.45  # meters, float
